...
exports.MLPredictionsService = void 0;
...
class MLPredictionsService {
     ...
     */
    static async forecastOccupancy(hotelId, daysToForecast = 7) {
        // 1. Récupérer l'historique des réservations passées
        const history = await database_1.prisma.roomOrder.groupBy({
            by: ['createdAt'],
        ...
        logger_1.logger.info(`Occupancy forecast generated: hotelId=${hotelId} daysToForecast=${daysToForecast}`);
        return predictions;
    }
    /**
     * Détection d'anomalies sur le Room Service (Isolation Forest / Z-Score)
     */
    static async detectAnomalies(hotelId) {
        const today = new Date();
        today.setHours(0, 0, 0, 0);
        const todayOrders = await database_1.prisma.roomOrder.findMany({
...
exports.MLPredictionsService = MLPredictionsService;
//# sourceMappingURL=ml-predictions.service.js.map